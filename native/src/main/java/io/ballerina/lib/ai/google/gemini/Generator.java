...
/**
 * This class provides the native function to generate a response from an Gemini model.
 *
 * @since 1.0.0
 */
public class Generator {
    public static Object generate(Environment env, BObject modelProvider,
        ...
        return env.getRuntime().callFunction(
                ...
                modelProvider.get(StringUtils.fromString("modelName")), prompt, expectedResponseTypedesc);
    }
}
